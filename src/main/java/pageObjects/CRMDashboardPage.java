...
public class CRMDashboardPage {
	...
	//  this page is created for to define all the webelements located on CRM Dashboard page to till Published App page. 
        ...
        By activeincentivedetailsXaxisvalue= By.xpath("//div[@aria-label='column chart for EST. VALUE BY CATEGORY, Active Incentive Details has 24 columns']/div[3]/div[2]/*[name()='svg']/*[local-name() = 'g'][7]"); //Locator for Active Incentive Details_X axis value
        By activeincentivedetailsYaxisvalue= By.xpath("//div[@aria-label='column chart for EST. VALUE BY CATEGORY, Active Incentive Details has 24 columns']/div[3]/div[2]/*[name()='svg']/*[local-name() = 'g'][8]"); //Locator for Active Incentive Details_Y axis value
